  ...
  return (
    <Card className="w-full max-w-2xl mx-auto overflow-hidden">
      ...
      <CardHeader>
        ...
        <CardDescription>
          Set up a new content competition with a prize pool
        </CardDescription>
      </CardHeader>
      <CardContent>
        {error && (
        ...
        {txHash && (
          <Alert className="mb-6 animate-in fade-in-50 duration-300">
            ...
            <AlertDescription>
              Your competition has been created! Transaction hash:{' '}
              {txHash.slice(0, 10)}...
            </AlertDescription>
          </Alert>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="prizePool">Prize Pool (GHO)</Label>
            <Input
              id="prizePool"
              type="number"
              step="0.01"
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      'w-full justify-start text-left font-normal',
                      !votingDate && 'text-muted-foreground'
                    )}
                  >
                    <CalendarIcon className="mr-2 h-4 w-4" />
